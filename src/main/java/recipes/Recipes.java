...
public class Recipes {
	...
	private void displayMenu() {
	  ...
	  while(!done) {
		  ...
		  System.out.println("ln Error;" + e.toString() + "Try again.");
	  }
	  }
	...
	private void deleteRecipe() {
		listRecipes();
		Integer recipeId = getIntInput("Enter the recipe ID of the recipe to delete");
	...
	private void addStepToCurretRecipe() {
		if(Objects.isNull(curRecipe)) {
			  System.out.println("\nPlease select a recipe first.");
			  return;
		}
	...
	private void addIngredientToCurrentRecipe() {
	  if(Objects.isNull(curRecipe)) {
		  ...
		  String instruction = 
				  getStringInput("Enter an istruction if any (like \"finely chopped\"");
		  ...
		  Units.forEach(unit -> System.out
				  .println("   " + unit.getUnitId() + ":" + unit.getUnitNameSingular() +
